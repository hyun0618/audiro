...
<body>
                ...
                <div class="card mb-3 ">
                    ...
                    <div class="card-body">
                     <!--     <h5 class="card-title m-1"
                            style="text-align: center;">Entire
                            Board</h5>
                        <h6 class="card-subtitle text-muted p-2"
                            style="text-align: center;">You can see
                            the entire posts</h6>
                        <img
                            style="display: block; margin: 0 auto; width: 100%;"
                            src="../images/alllogo.png" alt="전체게시판"> -->
                    </div>
                    <div class="card-body">
                        <p class="ps-3 pe-3" style="text-align: center;">"여행
                            어디로 가지? 어디로!"</p>
                    </div>
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><a
                            href="${main}"
                            style="text-decoration: none;">커뮤니티 메인</a></li>
                        <c:url var="alllist" value="/community/alllist">
                            <c:param name="id" value="${signedInUser}"></c:param>
                        </c:url>
                        <li class="list-group-item"><a
                            style="text-decoration: none;"
                            href="${alllist}">전체 목록</a></li>
                        <c:url var="matelist"
                            value="/community/matelist">
                            <c:param name="id" value="${signedInUser}"></c:param>
                        </c:url>
                        <li class="list-group-item"><a
                            style="text-decoration: none;"
                            href="${matelist}">여행 메이트</a></li>
                        <c:url var="freelist"
                            value="/community/freelist">
                            <c:param name="id" value="${signedInUser}"></c:param>
                        </c:url>
                        <li class="list-group-item"><a
                            style="text-decoration: none;"
                            href="${freelist}">자유게시판</a></li>
                        <c:url var="create" value="/community/create">
                            <c:param name="id" value="${signedInUser}"></c:param>
                        </c:url>
                        <li class="list-group-item"><a
                            style="text-decoration: none;" id="create"
                            href="${create}">글쓰기</a></li>
                    </ul>
                    <div class="card-body">
    ...
    <!-- 우리가 만드는 js파일 -->
    <c:url var="all" value="/js/community_all.js" />
