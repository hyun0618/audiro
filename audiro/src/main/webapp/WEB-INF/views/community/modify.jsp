                ...
                <main>
                    <div class="card border-light mb-3">
                     ...
                     <c:url var="modifyPage" value="/community/modify" />
                        <form id="selectForm" method="post" action="${modifyPage}">
                        ...
                        <c:choose> 
                                ...
                                <select class="form-select" id="PostTypeId" name="PostTypeId" style="float: left;">
                                    ...
                                    <option value="20" selected>여행메이트</option>
                                ...
                                <select class="form-select" id="PostTypeId" name="PostTypeId" style="float: left;">
                                    ...
                                    <option value="30" selected>자유게시판</option>
                                </select>
                            </c:when>                            
                        </c:choose>
                        </div>
                        <!-- 글타입 콤보박스 끝 -->
                                ...
                                <input type="hidden" name="usersId" value="${p.usersId}" />
                                <div class="mt-2 py-1" style="border-bottom: 1px solid grey;">
                                    <input class="form-control form-control-lg" name="title" value="${p.title}" type="text"  autofocus style="font-size: 220%; text-align: center;" placeholder="제목을 입력하세요.">
                                    <div class="flex-container">
                                        <div class="right-align me-2">
                                            <p class="m-2 p-2 mt-3 me-1"
                                                style="color: grey; font-size: 115%;">수정 시간 :</p>
                                ...
                                <div class="container mt-3">
                                    <div class="editor-container" id="editor">${p.content}</div>
                            ...
                            <div
                                ...
                                <div class="d-flex">
                                    ...
                                    <a id="deleteButton"
                                        ...
                                        href="${delete}" 
                                         onclick="return confirmDeletion()">삭제</a> <input
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('cancelButton').addEventListener('click', function(event) {
            ...
            var userConfirmed = confirm("수정을 종료하시겠습니까?");
            if (userConfirmed) {
